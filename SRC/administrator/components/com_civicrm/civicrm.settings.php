...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/reid_electronics?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost/reid_electronics?new_link=true');
  }
}
...
$civicrm_root = 'C:\wamp64\www\Joomla\administrator\components\com_civicrm\civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:\wamp64\www\Joomla\media\civicrm\templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/joomla/administrator/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'f0f7156e7bceb4e01abe42b3bf7a2d61');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:\wamp64\www\Joomla\media\civicrm\templates_c/mail.log');
// }
