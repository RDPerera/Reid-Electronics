...
class JFormFieldOauthusers extends JFormField
{
    ...
    public function getInput()
    {
        ...
        $return[]  = '<button class="google-oauth-trigger-button btn active btn-success" id="'.$this->id.'-button">'. JText::_('COM_EVENTGALLERY_OPTIONS_COMMON_GOOGLE_PHOTOS_REFRESH_TOKEN_BUTTON_LABEL') .'</bottons>';
