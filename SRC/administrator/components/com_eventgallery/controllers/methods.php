...
class EventgalleryControllerMethods extends JControllerAdmin
{
     ...
     * @return object
     */
    public function getModel($name = '', $prefix ='EventgalleryModel', $config = array('ignore_request' => true))
    {
        $model = parent::getModel($this->model_name, $prefix, $config);
        return $model;
    }
