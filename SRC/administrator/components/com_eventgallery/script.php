...
class com_eventgalleryInstallerScript
{
    ...
    */
    function preflight( /** @noinspection PhpUnusedParameterInspection */$type, $parent ) {
        ...
        if ($dbVersion!= null && version_compare($dbVersion, '3.11.2_2019-11-20', 'gt')) {
            $msg = "Downgrades are not supported. Please install the same or a newer version. Current version: " . $dbVersion . '. I tried to install database version 3.11.2_2019-11-20';
        ...
        $folders = array(
            ...
            // done delete the SQL folder. This will cause trouble with the database update
    ...
    private function updateDatabase($fixSchemaOnly) {
        ...
        if (!$fixSchemaOnly) {
            ...
            JFactory::getApplication()->enqueueMessage('Event Gallery 3.11.4 installed successfully.'." Updated the database schema from $currentVersion to $targetVersion");
