            ...
            <thead>
                <tr>
                    ...
                    <th width="130">
                        ...
                        <?php IF ($folder->isSortable() && $saveOrder):?><?php echo JHtml::_('grid.order',  $this->items, 'filesave.png', 'files.saveorder' ); ?><?php ENDIF; ?>
                    </th>
                    <th>
