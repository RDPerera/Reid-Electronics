                        ...
                        <td>
                            <div class="btn-group">
                                <?php IF ($item->isDefault()): ?>
                                    <a title="<?php echo JText::_('COM_EVENTGALLERY_BUTTON_ISDEFAULT_DESC'); ?>" href="#" onclick="return listItemTask('cb<?php echo $i; ?>','watermarks.undefault')" class="btn btn-micro active"><i class="icon-star"></i></a>
                                <?php ELSE:?>
                                    <a title="<?php echo JText::_('COM_EVENTGALLERY_BUTTON_NOTDEFAULT_DESC'); ?>" href="#" onclick="return listItemTask('cb<?php echo $i; ?>','watermarks.default')" class="btn btn-micro"><i class="icon-star-empty"></i></a>
                                <?php ENDIF ?>
