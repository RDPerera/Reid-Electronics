...
class EventgalleryRouter extends JComponentRouterBase
{
    ...
    private $supportedFileExtensionsRegEx = "jpg|JPG|gif|GIF|png|PNG|jpeg|JPEG";
    ...
    public function build(&$query)
    {
        ...
        if(isset($query['file']))
        {
            ...
            if ($config->get('sef_suffix')==1) {
                ...
                $result = preg_replace("/\.(".$this->supportedFileExtensionsRegEx."$)/i", "-\\1", $query['file']);
    ...
    protected function parseFileParameter($value) {
        ...
        $result = preg_replace("/-(".$this->supportedFileExtensionsRegEx."$)/i", ".\\1", $result);
        return $result;
    }
