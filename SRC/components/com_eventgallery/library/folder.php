...
abstract class EventgalleryLibraryFolder extends EventgalleryLibraryDatabaseObject implements EventgalleryLibraryInterfaceFoldercapability
{
	...
	*/
    ...
    public function hasPassword() {
        return strlen($this->getPassword())>0;
    }
    ...
    public function getMetadata() {
        ...
        if ($this->_metadata == NULL) {
            $registry = new JRegistry($this->_folder->metadata);
    ...
    public function isVisible() {
        ...
        return EventgalleryLibraryCommonUsergroups::validateWithOverride($minUserGroups, $folderUserGroups, $userUserGroups);
    }
    ...
    public function doAllowDownloadOfOriginalImage($config) {
        ...
        return EventgalleryLibraryCommonUsergroups::validateWithOverride($defaultUserGroups, $folderUserGroups, $userUserGroups);
    }
